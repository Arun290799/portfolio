		...
		<section id="contact" className="relative py-32 px-6 overflow-hidden">
			<div className="mx-auto max-w-6xl relative z-10">
				...
				<motion.div className="text-center mb-20" variants={modernVariants.fadeInUp}>
					<motion.h2 className="text-4xl md:text-6xl font-bold mb-6 text-white">Get In Touch</motion.h2>
				</motion.div>
						...
						>
							<div className="flex items-center gap-4">
								...
								<div>
									...
									<p className="text-white/80">+91 8142403666</p>
								</div>
							</div>
						</motion.div>
						...
						>
							<div className="flex items-center gap-4">
								...
								<div>
									...
									<p className="text-white/80">polojuarunkumar2@gmail.com</p>
								</div>
							</div>
						</motion.div>
							...
							<form className="space-y-6">
								...
								<div>
									...
									<input
										...
										className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:border-white/40 focus:bg-white/15 transition-all duration-50"
									/>
								</div>
								...
								<div>
									...
									<textarea
										...
										rows={5}
										className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:border-white/40 focus:bg-white/15 transition-all duration-50 resize-none"
									/>
								</div>
								...
								<motion.button
									type="submit"
									className="w-full px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-50 flex items-center justify-center gap-2"
