									...
									<div className="flex flex-col h-full">
										...
										<div className="flex flex-wrap gap-2 mb-6">
											{project.techStack.map((tech: string) => (
												<span
													key={tech}
													className="px-3 py-1.5 text-xs rounded-full text-white/90 border border-white/30"
												>
													{tech}
												</span>
											))}
										...
										<div className="flex gap-3 mt-auto">
											{project.links.live && (
												<a
													...
													target="_blank"
													className="inline-flex items-center gap-2 px-4 py-2 text-sm rounded-lg bg-white/10 text-white border border-white/20 hover:bg-transparent hover:border-white/40 transition-all duration-50"
												>
													<span>View Live</span>
													<ArrowRight size={14} />
												</a>
											...
											{project.links.github && (
												<a
													...
													target="_blank"
													className="inline-flex items-center justify-center w-10 h-10 rounded-lg text-white border border-white/20 hover:bg-white hover:text-black transition-all duration-50"
												>
