										...
										<div className="flex gap-3 mt-auto">
											...
											{project.links.github && (
												<a
													...
													target="_blank"
													className="inline-flex items-center justify-center w-10 h-10 rounded-lg text-primary border border-white/20 hover:bg-white hover:text-black transition-all duration-50"
												>
