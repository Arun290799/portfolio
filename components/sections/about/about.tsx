			...
			<div className="mx-auto max-w-6xl relative z-10">
				<StaggerContainer>
					...
					<motion.div className="text-center mb-20" variants={modernVariants.fadeInUp}>
						<motion.h2 className="text-4xl md:text-6xl font-bold mb-6 text-white">About Me</motion.h2>
					...
					<div className="grid lg:grid-cols-2 gap-16 items-center">
						...
						<StaggerItem className="space-y-6">
							<motion.div variants={modernVariants.fadeInUp}>
								<h3 className="text-2xl font-semibold text-white mb-4">Building the Future of Web</h3>
							...
							<motion.div variants={modernVariants.fadeInUp}>
								...
								<div className="flex flex-wrap gap-3">
									{skills.map((skill, index) => (
										<motion.span
											key={skill}
											className="px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg text-sm font-medium text-white/80 hover:bg-white/20 transition-all duration-50"
